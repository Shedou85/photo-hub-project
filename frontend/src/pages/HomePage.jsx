...
function HomePage() {
    ...
    '@graph': [
      {
        ...
        sameAs: [
          'https://www.facebook.com/profile.php?id=61582196282958',
  ...
  return (
    <div className="min-h-screen bg-surface-darker font-['Outfit',sans-serif]">
      ...
      {/* ── Footer ───────────────────────────────────────────────── */}
      <footer className="bg-surface-darkest border-t border-white/[0.05]">
        {/* Mini CTA strip */}
        <div className="border-b border-white/[0.05] py-10 px-6">
          <div className="max-w-6xl mx-auto text-center">
            <h3 className="text-lg font-semibold text-white mb-2">{t('home.footer.getStarted')}</h3>
            <p className="text-sm text-white/40 mb-5">{t('home.footer.getStartedDesc')}</p>
            <Link
              to="/register"
              className="inline-flex items-center gap-2 py-2.5 px-6 rounded text-sm font-semibold text-white no-underline bg-[linear-gradient(135deg,#3b82f6_0%,#6366f1_100%)] hover:opacity-90 transition-opacity duration-150 shadow-[0_4px_16px_rgba(99,102,241,0.25)]"
            >
              {t('home.footer.getStartedBtn')}
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              <div className="flex items-center gap-2.5 mb-3">
                ...
                <span className="font-semibold text-white text-sm tracking-tight">PixelForge</span>
              </div>
              <p className="text-[13px] text-white/40 leading-relaxed mb-4">{t('home.footer.tagline')}</p>
              {/* Social icons */}
              <div className="flex items-center gap-3">
                <a
                  href="https://www.facebook.com/profile.php?id=61582196282958"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 rounded-md bg-white/[0.06] flex items-center justify-center text-white/40 hover:text-white/80 hover:bg-white/[0.1] transition-all"
                  aria-label="Facebook"
                >
                ...
                <a
                  href="https://www.instagram.com/pixelforgeapp/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 rounded-md bg-white/[0.06] flex items-center justify-center text-white/40 hover:text-white/80 hover:bg-white/[0.1] transition-all"
                ...
                <a
                  href="mailto:pixelforge@pixelforge.pro"
                  className="w-8 h-8 rounded-md bg-white/[0.06] flex items-center justify-center text-white/40 hover:text-white/80 hover:bg-white/[0.1] transition-all"
                  aria-label="Email"
                >
            ...
            {/* Product column */}
            <div>
              <h4 className="text-xs font-semibold text-white/60 uppercase tracking-[0.08em] mb-3">{t('home.footer.product')}</h4>
              <ul className="space-y-2 list-none p-0 m-0">
                <li><a href="#features" className="text-[13px] text-white/40 hover:text-white/70 transition-colors no-underline">{t('home.footer.features')}</a></li>
                <li><a href="#plans" className="text-[13px] text-white/40 hover:text-white/70 transition-colors no-underline">{t('home.footer.pricing')}</a></li>
                <li><Link to="/faq" className="text-[13px] text-white/40 hover:text-white/70 transition-colors no-underline">{t('home.footer.faq')}</Link></li>
              </ul>
            </div>
            ...
            <div>
              <h4 className="text-xs font-semibold text-white/60 uppercase tracking-[0.08em] mb-3">{t('home.footer.getStarted')}</h4>
              <p className="text-[13px] text-white/40 leading-relaxed mb-3">{t('home.footer.getStartedDesc')}</p>
              <Link
                to="/register"
                className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-indigo-400 hover:text-indigo-300 no-underline transition-colors"
              >
                {t('home.footer.getStartedBtn')}
        ...
        <div className="border-t border-white/[0.05] py-5 px-6">
          <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
            <p className="text-xs text-white/30">{t('home.footer.rights')}</p>
            <p className="text-xs text-white/30">
              {t('home.footer.madeWith')} <span className="text-red-400">♥</span> {t('home.footer.forPhotographers')}
            </p>
          </div>
        </div>
      </footer>
