  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.status === "OK") {
        ...
        setError(t("passwordReset.expiredLink"));
        ...
        <div className="relative z-10 w-full max-w-[420px] mx-4 mt-16 bg-white/[0.04] border border-white/10 rounded-lg px-8 py-9 shadow-xl">
          {!token ? (
            <>
              ...
              <div className="bg-red-500/10 border border-red-500/20 text-red-400 rounded-sm px-4 py-3 text-sm mb-6">
                {t("passwordReset.expiredLink")}
              </div>
              <Link to="/forgot-password" className="text-indigo-400 hover:text-indigo-300 transition-colors duration-150 no-underline text-sm">
            ...
            <>
              ...
              <form onSubmit={handleSubmit}>
                ...
                >
                  {loading ? "..." : t("passwordReset.submit")}
                </button>
              </form>
