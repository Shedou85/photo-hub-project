/**
 * Generates a platform-specific script that copies selected photos
 * into a _Selected subfolder and opens it in the file explorer.
 *
 ...
 */
export function generateCopyScript(sourceFolder, selectedPhotos, collectionName) {
  ...
  if (isWindows) {
    ...
    const lines = [
      ...
      'chcp 65001 >nul',
      'echo ==========================================',
      'echo   PixelForge - Copy Selected Photos',
      'echo ==========================================',
      'echo.',
    ...
    lines.push('echo.');
    lines.push(`echo Opening folder: ${selectedFolder}`);
