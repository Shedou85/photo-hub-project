# Requirements Archive: v2.0 Delivery & Polish
...
- [ ] **DWNLD-05**: Individual downloads work reliably across browsers (Chrome, Safari, Firefox) via server Content-Disposition headers
