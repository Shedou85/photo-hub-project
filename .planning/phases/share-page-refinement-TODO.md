# SharePage Design Refinement TODO

Status: 🟢 Not Started | 🟡 In Progress | ✅ Completed

## Phase 1: Hero & Branding 🟡
- [x] **1.1. Dynamic Hero Header:** Use the photographer's chosen cover photo as a high-impact background for the gallery title and client name. ✅
- [x] **1.2. Parallax Effect:** Implement a smooth parallax scrolling effect for the hero background image. ✅
- [x] **1.3. Typography Overhaul:** Refine fonts and spacing for the gallery title and subtitles to feel more "premium". ✅
